...
public class RecetteControllerTest {
	...
	public void can_get_all() throws Exception {
		...
		String expected = "[{\"recette\":{\"id\":1,\"libelle\":\"recette1\",\"niveau\":1,\"recette\":\"bla bla bla bla\",\"temps\":2}},{\"recette\":{\"id\":2,\"libelle\":\"recette2\",\"niveau\":2,\"recette\":\"bla bla bla\",\"temps\":6}},{\"recette\":{\"id\":3,\"libelle\":\"recette3\",\"niveau\":4,\"recette\":\"bla bla\",\"temps\":1}}]";
	...
	public void can_find_by_id() throws Exception {
		...
		String json = response.getContentAsString();
		String expected = "{\"recette\":{\"id\":12345,\"libelle\":\"fraisier\",\"niveau\":3,\"recette\":\"Avec une genoise et des fraises...\",\"temps\":2}}";
		JSONAssert.assertEquals(expected, json, true);
	...
	public void can_find_list_by_libelle() throws Exception {
		...
		String expected = "[{\"recette\":{\"id\":12345,\"libelle\":\"macarons chocolat\",\"niveau\":1,\"recette\":\"bla bla bla\",\"temps\":2}},{\"recette\":{\"id\":67890,\"libelle\":\"Macarons Pistache\",\"niveau\":2,\"recette\":\"bla bla bla\",\"temps\":3}}]";
	...
	public void can_update() throws Exception {
		...
		String json = "{\"recette\":{\"id\":12345,\"libelle\":\"fraisier\",\"niveau\":3,\"recette\":\"Avec une genoise et des fraises...\",\"temps\":2}}";
	...
	public void should_post_create_new_recette() throws Exception {
		...
		String json = "{\"recette\":{\"libelle\":\"Le fraisier\",\"niveau\":2,\"recette\":\"recette secrette\",\"temps\":4}}";
