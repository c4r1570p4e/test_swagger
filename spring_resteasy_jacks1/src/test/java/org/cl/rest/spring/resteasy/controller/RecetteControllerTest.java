...
public class RecetteControllerTest {
	...
	public void can_get_all() throws Exception {
		...
		String expected = "[{\"identifiant\":\"1\",\"titre\":\"recette1\",\"niveauDeDifficulte\":1,\"recette\":\"bla bla bla bla\",\"tempsPreparation\":2},{\"identifiant\":\"2\",\"titre\":\"recette2\",\"niveauDeDifficulte\":2,\"recette\":\"bla bla bla\",\"tempsPreparation\":6},{\"identifiant\":\"3\",\"titre\":\"recette3\",\"niveauDeDifficulte\":4,\"recette\":\"bla bla\",\"tempsPreparation\":1}]";
	...
	public void can_find_by_id() throws Exception {
		...
		String json = response.getContentAsString();
		String expected = "{\"identifiant\":\"12345\",\"titre\":\"fraisier\",\"niveauDeDifficulte\":3,\"recette\":\"Avec une genoise et des fraises...\",\"tempsPreparation\":2}";
		JSONAssert.assertEquals(expected, json, true);
	...
	public void can_find_list_by_libelle() throws Exception {
		...
		String expected = "[{\"identifiant\":\"12345\",\"titre\":\"macarons chocolat\",\"niveauDeDifficulte\":1,\"tempsPreparation\":2},{\"identifiant\":\"67890\",\"titre\":\"Macarons Pistache\",\"niveauDeDifficulte\":2,\"tempsPreparation\":3}]";
	...
	public void can_update() throws Exception {
		...
		String json = "{\"identifiant\":12345,\"titre\":\"fraisier\",\"niveauDeDifficulte\":3,\"recette\":\"Avec une genoise et des fraises...\",\"tempsPreparation\":2}";
	...
	public void should_post_create_new_recette() throws Exception {
		...
		String json = "{\"titre\":\"Le fraisier\",\"niveauDeDifficulte\":2,\"recette\":\"recette secrette\",\"tempsPreparation\":4}";
